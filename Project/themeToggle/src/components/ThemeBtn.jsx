...
export default function ThemeBtn() {
    ...
    const {themeMode, lightTheme, darkTheme} = useTheme()           // calling useTheme hook which are created in theme.js....
    const onChangeTheme = (e) => {
        const darkModeStatus = e.target.checked         // this will check check box is checked or not
        if(darkModeStatus) {                            // if check box is checked then change theme to dark or else light.
            darkTheme()
        }
        else {
            lightTheme()
    ...
    return (
        <label className="relative inline-flex items-center cursor-pointer">
            <input
                ...
                onChange={onChangeTheme}        // this method telling about check box change..
